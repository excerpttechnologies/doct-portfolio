...
// import { motion, useInView } from "framer-motion";
// import awardImg from "@/assets/award.webp";
// import awardImg2 from "@/assets/award2.webp";
// import {
//   Trophy,
//   Star,
//   Medal,
...
//               />
//               <div style={{ position: "absolute", inset: 0, background: "linear-gradient(145deg, rgba(200,164,93,0.1) 0%, rgba(0,0,0,0.1) 100%)", pointerEvents: "none" }} />
//               <div style={{ position: "absolute", bottom: 20, right: 20, background: "rgba(255,255,255,0.85)", backdropFilter: "blur(8px)", borderRadius: 40, padding: "2px 6px", fontSize: 11, fontWeight: 600, color: GOLD_DARK, letterSpacing: "0.5px", border: `1px solid ${GOLD}40` }}>
//                 ✦ Literary Legend ✦
//               </div>
//             </motion.div>
...
//                 <span style={{ display: "block", fontSize: 28, fontWeight: 700, color: GOLD }}>14+</span>
//                 <span style={{ fontSize: 11, color: "#888", letterSpacing: "0.1em", textTransform: "uppercase" }}>Awards</span>
//               </div>
//               <div style={{ width: 1, background: "rgba(200,164,93,0.2)" }} />
//               <div style={{ textAlign: "center" }}>
//                 <span style={{ display: "block", fontSize: 28, fontWeight: 700, color: GOLD }}>3+</span>
//                 <span style={{ fontSize: 11, color: "#888", letterSpacing: "0.1em", textTransform: "uppercase" }}>Decades</span>
//               </div>
//               <div style={{ width: 1, background: "rgba(200,164,93,0.2)" }} />
//               <div style={{ textAlign: "center" }}>
//                 <span style={{ display: "block", fontSize: 28, fontWeight: 700, color: GOLD }}>∞</span>
//                 <span style={{ fontSize: 11, color: "#888", letterSpacing: "0.1em", textTransform: "uppercase" }}>Legacy</span>
//               </div>
//             </motion.div>
//           </motion.div>
...
//                 Dr. K. G. Lakshmi Narayanappa
//               </p>
//               <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 13, letterSpacing: "0.28em", textTransform: "uppercase", fontWeight: 800, marginBottom: 14, background: "linear-gradient(135deg, #C8A45D 0%, #B58E48 100%)", WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent", display: "inline-block" }}>
//                 RECOGNITION &amp; HONOURS
//               </p>

//               <h2 style={{ fontSize: "clamp(42px, 6vw, 58px)", fontWeight: 500, color: "#121212", margin: "0 0 14px", lineHeight: 1.12, letterSpacing: "-0.02em", fontFamily: "'Cormorant Garamond', 'Georgia', serif" }}>
//                 Awards &amp;{" "}
//                 <span style={{ color: GOLD, fontWeight: 700, borderBottom: `2px solid ${GOLD}40`, display: "inline-block" }}>Achievements</span>
//               </h2>
...
//             {/* Awards List */}
//             <div style={{ maxHeight: "calc(100vh - 280px)", overflowY: "auto", paddingRight: 8, scrollbarWidth: "thin", scrollbarColor: `${GOLD} #e2e2e2` }} className="custom-scroll">
//               {awards.map((award, idx) => {
//                 const Icon = award.icon;
//                 return (
//                   <motion.div
...
//                     animate={isInView ? { opacity: 1, x: 0 } : {}}
//                     transition={{ duration: 0.45, delay: 0.05 + idx * 0.035 }}
//                     style={{ display: "flex", alignItems: "center", gap: 18, padding: "14px 14px 14px 0", borderBottom: "1px solid rgba(200, 164, 93, 0.12)", cursor: "default", transition: "all 0.2s ease", borderRadius: 12, marginBottom: 2 }}
//                     whileHover={{ backgroundColor: "rgba(200,164,93,0.05)", paddingLeft: 8, borderRadius: 16, transition: { duration: 0.2 } }}
//                   >
//                     <span style={{ fontFamily: "'Inter', monospace", fontSize: 13, fontWeight: 600, color: GOLD, minWidth: 36, textAlign: "right", letterSpacing: "0.5px" }}>
//                       {String(idx + 1).padStart(2, "0")}
...
//             >
//               <div style={{ display: "inline-flex", alignItems: "center", gap: 14, padding: "10px 28px", borderRadius: 100, background: "#FDF9F2", border: `1px solid rgba(200,164,93,0.3)` }}>
//                 <span style={{ width: 6, height: 6, borderRadius: "50%", backgroundColor: GOLD, display: "inline-block" }} />
//                 <span style={{ fontSize: 11, letterSpacing: "0.25em", fontFamily: "'Inter', sans-serif", color: GOLD_DARK, textTransform: "uppercase", fontWeight: 700 }}>
//                   A Journey of Literary Excellence
//                 </span>
...
//               />
//               <div style={{ position: "absolute", inset: 0, background: "linear-gradient(145deg, rgba(200,164,93,0.1) 0%, rgba(0,0,0,0.1) 100%)", pointerEvents: "none" }} />
//               <div style={{ position: "absolute", bottom: 0, right: 20, background: "rgba(255,255,255,0.85)", backdropFilter: "blur(8px)", borderRadius: 40, padding: "6px 16px", fontSize: 11, fontWeight: 600, color: GOLD_DARK, letterSpacing: "0.5px", border: `1px solid ${GOLD}40` }}>
//                 ✦ Literary Legend ✦
//               </div>
//             </motion.div>
...
//             {/* Awards List */}
//             <div style={{ maxHeight: "calc(100vh - 300px)", overflowY: "auto", paddingRight: 8, scrollbarWidth: "thin", scrollbarColor: `${GOLD} #e2e2e2` }} className="custom-scroll">
//               {awards.map((award, idx) => {
//                 const Icon = award.icon;
//                 return (
//                   <motion.div
...
//                     animate={isInView ? { opacity: 1, x: 0 } : {}}
//                     transition={{ duration: 0.45, delay: 0.05 + idx * 0.035 }}
//                     style={{ display: "flex", alignItems: "center", gap: 18, padding: "16px 14px 16px 0", borderBottom: "1px solid rgba(200, 164, 93, 0.12)", cursor: "default", transition: "all 0.2s ease", borderRadius: 12, marginBottom: 2 }}
//                     whileHover={{ backgroundColor: "rgba(200,164,93,0.05)", paddingLeft: 8, borderRadius: 16, transition: { duration: 0.2 } }}
//                   >
//                     <span style={{ fontFamily: "'Inter', monospace", fontSize: 13, fontWeight: 600, color: GOLD, minWidth: 36, textAlign: "right", letterSpacing: "0.5px" }}>
//                       {String(idx + 1).padStart(2, "0")}
    ...
    return (
        ...
        >
          ...
          >
            ...
            {/* ===== RIGHT SIDE - AWARDS LIST ===== */}
            <div style={{ flex: 1.85, minWidth: 420 }}>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                animate={isInView ? { opacity: 1, y: 0 } : {}}
                transition={{ duration: 0.7, delay: 0.1 }}
              ...
              >
                ...
                <h2 style={{ fontSize: "clamp(32px, 5vw, 50px)", fontWeight: 500, color: "#121212", margin: "0 0 18px", lineHeight: 1.12, letterSpacing: "-0.02em", fontFamily: "'Cormorant Garamond', 'Georgia', serif",whiteSpace: "nowrap"}}>
                  Awards &amp;{" "}
                  <span style={{ color: GOLD, fontWeight: 700, borderBottom: `2px solid ${GOLD}40`, display: "inline-block" }}>Achievements</span>
                </h2>
