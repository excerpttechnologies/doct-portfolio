...
const awards = [
  { title: "Karnataka Sahitya Akademi Award", year: "1998", desc: "For outstanding contribution to Kannada prose literature.", icon: Trophy },
  { title: "Rajyotsava Award", year: "2005", desc: "State's highest civilian honour for public service and literary excellence.", icon: Star },
  { title: "Kendra Sahitya Akademi Fellowship", year: "2010", desc: "Nominated as Fellow for lifetime contribution to Indian literature.", icon: Medal },
